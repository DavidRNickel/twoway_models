...
if __name__=='__main__':
    ...
    ax1,ax2,ax3,ax4=axs
    ax1.semilogy(tw_comparison_snr2, twlc_k6m3t9_snr1_1, label='LC M3', color='blue', marker='o', markersize=8)
    ax1.semilogy(tw_comparison_snr2, twlc_k6m2t6_snr1_1, label='LC M2', color='blue', ls='-.', marker='o', markersize=8)
    ax1.semilogy(tw_comparison_snr2, twbaf_k6m3t9_snr1_1, label='BAF M3', color='black', marker='o', markersize=8)
    ...
    ax3.semilogy(tw_comparison_snr2, twlc_k6m2t6_snr1_n1, label='LC M2', color='blue', ls='-.', marker='o', markersize=8)
    ax3.semilogy(tw_comparison_snr2, twbaf_k6m3t9_snr1_n1, label='BAF M3', color='black', marker='o', markersize=8)
