...
if __name__=='__main__':
    ...
    # plt.figure(3)
    # plt.semilogy(tw_comparison_snr2, twlc_fixsnr1_1_snr2_15, label='TWLC (Fixed)', color='blue', marker='o', markersize=8)
    # plt.semilogy(tw_comparison_snr2, twlc_k6m3t9_snr1_1, label='TWLC (Orig)', color='blue', ls='-.', marker='^', markersize=10)
    # plt.semilogy(tw_comparison_snr2, twbaf_fixsnr1_1_snr2_15, label='TWBAF (Fixed)', color='black', marker='o', markersize=8)
    ...
    ax1,ax2,ax3,ax4=axs
    ax1.semilogy(tw_comparison_snr2, twlc_k6m3t9_snr1_1, label='TWLC: K6, M3', color='blue', marker='o', markersize=8)
    ax1.semilogy(tw_comparison_snr2, twlc_k6m2t6_snr1_1, label='TWLC: K6, M2', color='blue', ls='-.', marker='o', markersize=8)
    ax1.semilogy(tw_comparison_snr2, twbaf_k6m3t9_snr1_1, label='TWBAF: K6, M3', color='black', marker='o', markersize=8)
    ...
    ax2.semilogy(tw_comparison_snr2, twlc_k6m2t6_snr1_n1, label='TWLC: K6, M2', color='blue', ls='-.', marker='o', markersize=8)
    ax2.semilogy(tw_comparison_snr2, twbaf_k6m3t9_snr1_n1, label='TWBAF: K6, M3', color='black', marker='o', markersize=8)
    ...
    ax3.semilogy(tw_comparison_snr2, twbaf_k4m2t5_snr1_1, label='TWBAF: K4, M2', color='black', marker='o', markersize=8)
    ax3.semilogy(tw_comparison_snr2, twrnn_k4m2t5_snr1_1, label='TWRNN: K4, M2', color='orange', marker='o', markersize=8)
    ax3.set_xlabel(r'SNR$_2$ [dB]'+'\n' +r'(b) BLER for SNR$_1$=1.', fontsize=12, loc='center')

    ax4.semilogy(tw_comparison_snr2, twlc_k4m2t5_snr1_n1, label='TWLC: K4, M2', color='blue', marker='o', markersize=8)
    ax4.semilogy(tw_comparison_snr2, twbaf_k4m2t5_snr1_n1, label='TWBAF: K4, M2', color='black', marker='o', markersize=8)
    ax4.semilogy(tw_comparison_snr2, twrnn_k4m2t5_snr1_n1, label='TWRNN: K4, M2', color='orange', marker='o', markersize=8)
